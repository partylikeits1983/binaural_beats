  ...
  return (
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-8">
        ...
        {/* Top area: Blocks */}
        <div className="grid sm:grid-cols-12 gap-1 py-2 md:py-12 border-t border-gray-200">
          ...
          {/* 2nd block */}
          <div className="sm:col-span-4 md:col-span-2 lg:col-span-7">
            <h6 className="text-gray-800 font-medium mb-2">Research</h6>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">Made by <a className="text-blue-600 hover:underline" href="https://cruip.com/">Alexander Lee</a>. All rights reserved.</div>
